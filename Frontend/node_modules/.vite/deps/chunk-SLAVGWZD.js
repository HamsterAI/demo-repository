...
import {
  ...
  optimismGoerli,
  optimismSepolia
} from "./chunk-RHLAFLDC.js";
import {
  serializeTransaction
} from "./chunk-2K2CKL25.js";
import {
  BaseError,
  InvalidAddressError,
...
var getTransactionRecipient = (data, to) => {
  ...
  if (!data || data === "0x") {
    return to !== null && to !== void 0 ? to : void 0;
  }
  return void 0;
};
...
var ViemUiTransaction = class extends Eip1559FeeFeed {
  ...
  getTransactionRecipient() {
    var _a;
    return getTransactionRecipient(this.transaction.data, (_a = this.transaction.to) !== null && _a !== void 0 ? _a : void 0);
  }
  estimateL1Fee() {
    return __awaiter(this, void 0, void 0, function* () {
      var _a;
    ...
    request: (args) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (onPersonalSign && method === "personal_sign") {
        ...
        return onPersonalSign({ args, message, provider }).catch((error) => {
          if (error instanceof UserRejectedRequestError2) {
      ...
      if (onSendTransaction && method === "eth_sendTransaction") {
        ...
        return onSendTransaction({ args, provider, transaction }).catch((error) => {
          if (isTransactionExecutionError(error) && error.walk() instanceof UserRejectedTransactionError) {
            throw new UserRejectedRequestError(error.walk());
          }
          if (error instanceof UserRejectedTransactionError) {
            throw new UserRejectedRequestError(error);
          }
...
var EthereumWalletConnector = class extends WalletConnectorBase {
  ...
  isTestnet() {
    return __awaiter(this, void 0, void 0, function* () {
      var _a, _b;
      const chain2 = (_a = yield this.getPublicClient()) === null || _a === void 0 ? void 0 : _a.chain;
      const evmNetwork = this.evmNetworks.find((n) => n.chainId === (chain2 === null || chain2 === void 0 ? void 0 : chain2.id));
      ...
      return (_b = chain2 === null || chain2 === void 0 ? void 0 : chain2.testnet) !== null && _b !== void 0 ? _b : false;
    });
  }
...
*/
//# sourceMappingURL=chunk-SLAVGWZD.js.map
